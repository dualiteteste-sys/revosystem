...
-- Reversibilidade: basta habilitar novamente com
--   ALTER TABLE public.products ENABLE ROW LEVEL SECURITY;
-- Observação: Não modifica dados nem dependências de FK.
-- =============================================================================
...
BEGIN
  ...
  -- 2) (Opcional) Se existirem policies residuais, limpá-las (não é obrigatório p/ o linter)
  --    Mantido como no-op se não existirem.
  FOR
    -- coleta nomes de policies para dropar com segurança
    pol IN
      SELECT pol.polname
