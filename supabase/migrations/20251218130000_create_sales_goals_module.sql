/*
# [Feature] Módulo de Metas de Vendas (revisado/seguro)
...
- RPCs: casts de email para text; COALESCE em valor_atingido; nullif em responsavel_id; SD + search_path; funções read-only STABLE
*/
